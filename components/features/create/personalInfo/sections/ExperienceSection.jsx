...
const ExperienceSection = memo(({ experiences = [], updateArrayItem, addArrayItem, removeArrayItem }) => {
  return (
    <Section icon={Briefcase} color="#10b981" title="ประสบการณ์ทำงาน">
      <div className="space-y-4">
        {experiences.map((exp, idx) => (
          <div key={exp.id || idx} className="border border-emerald-100 rounded-xl p-4 bg-emerald-50/40">
