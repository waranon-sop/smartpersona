...
const EducationSection = memo(({ educations = [], updateArrayItem, addArrayItem, removeArrayItem }) => {
  return (
    <Section icon={GraduationCap} color="#0ea5e9" title="การศึกษา">
      <div className="space-y-4">
        {educations.map((edu, idx) => (
          <div key={edu.id || idx} className="border border-sky-100 rounded-xl p-4 bg-sky-50/40">
